...
const runVerification = async () => {
  ...
  assert(TOOLS.length === 5, `Expected exactly 5 tools, got ${TOOLS.length}`);
  ...
  assert(sendEmail.parameters.properties.photoIds.minItems === 1, "sendEmail.photoIds minItems should be 1");
  ...
  assert(sendEmail.parameters.required.includes("photoIds"), "sendEmail required should include photoIds");
  ...
  assert(sendWhatsApp.parameters.properties.photoIds.minItems === 1, "sendWhatsApp.photoIds minItems should be 1");
